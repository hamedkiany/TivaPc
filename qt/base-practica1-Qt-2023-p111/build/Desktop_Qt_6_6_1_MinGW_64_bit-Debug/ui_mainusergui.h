...
public:
    ...
    void setupUi(QWidget *MainUserGUI)
    {
        ...
        tabWidget->setGeometry(QRect(60, 50, 711, 391));
        tab = new QWidget();
        ...
        layoutWidget->setGeometry(QRect(440, 30, 171, 243));
        ...
        Knob->setUpperBound(10.000000000000000);
        ...
        checkBox1->setGeometry(QRect(50, 200, 91, 24));
        checkBox2 = new QCheckBox(tab);
        checkBox2->setObjectName("checkBox2");
        checkBox2->setGeometry(QRect(50, 230, 91, 24));
        checkBox3 = new QCheckBox(tab);
        checkBox3->setObjectName("checkBox3");
        checkBox3->setGeometry(QRect(50, 260, 91, 24));
    ...
    void retranslateUi(QWidget *MainUserGUI)
    {
        ...
        label_2->setText(QCoreApplication::translate("MainUserGUI", "Knob", nullptr));
        checkBox1->setText(QCoreApplication::translate("MainUserGUI", "CheckBox", nullptr));
        checkBox2->setText(QCoreApplication::translate("MainUserGUI", "CheckBox", nullptr));
        checkBox3->setText(QCoreApplication::translate("MainUserGUI", "CheckBox", nullptr));
